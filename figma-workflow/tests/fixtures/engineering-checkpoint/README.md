...
- `pre-handoff.expected.md`:Phase E review gate 通过后,展示 `figma-design-diff` / `figma-ui-handoff` / `implementation-evidence.md` quality gate / `figma-assets-validate` 状态和 handoff 前风险。
